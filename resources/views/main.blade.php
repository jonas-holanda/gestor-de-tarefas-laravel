...
<div class="container mb-3">
    <div class="row">
        <div class="col">
            ...
            <div class="row align-atins-center mb-3">
                <div class="col">
                    <h4>Tarefas</h4>
                </div>
                ...
                <div class="col-6 text-center">
                    <form action="{{ route('search_submit') }}" method="post">
                        ...
                        <div class="d-flex">
                            ...
                            <label for="" class="me-2 align-self-center">Estado:</label>
                            <select name="filter" id="filter" class="form-select">
                                ...
                                <option value="{{ Crypt::encrypt('in_progress') }}" @php echo (!empty($filter) && $filter == 'in_progress') ? 'selected' : '' @endphp>Em Andamento</option>
                ...
                <div class="col text-end">
                    <a class="btn btn-primary" href="{{ route('new_task') }}"><i class="bi bi-plus-square me-2"></i>Nova Tarefa</a>
                </div>
            </div>

            @if (count($tasks) != 0)
            <table class="table table-stripped table-bordered" id="table_tasks" width="100%">
