...
<div class="container">
    <div class="row mt-5">
        <div class="col">
            ...
            <p class="my-5 text-center">Deseja excluir essa tarefa?</p>

            <div class="my-4 text-center">
                <a href="{{ route('index') }}" class="btn btn-dark px-5 m-1"><i class="bi bi-x-circle me-2"></i>Cancelar</a>
                <a href="{{ route('delete_task_confirm', ['id' => Crypt::encrypt($task->id)]) }}" class="btn btn-danger px-5 m-1"><i class="bi bi-trash me-2"></i>Excluir</a>
            </div>
        </div>
    </div>
</div>
